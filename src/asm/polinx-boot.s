...
times 2*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 3

times 3*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 4


times 9*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 10

times 10*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 11

times 13*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 14

times 14*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 15

times 15*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 16

times 16*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 17

times 17*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 18

times 18*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 19

times 19*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 20

times 20*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 21


times 21*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 22

times 34*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 35

times 35*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 36


times 36*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 37

times 38*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 38



times 100*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 bytes
DB 100

times 80*2*18*512 - ($ - $$) db 0 ; fill with 0 untill arrive 512 byte